            ...
            <form onSubmit={(e) => {
                ...
                <div className="w-full md:w-1/2 flex flex-col gap-4">
                    ...
                    <textarea
                        ...
                        className="w-full px-4 py-3 rounded-lg bg-gray-900 border border-gray-700 text-white placeholder-gray-500 focus:ring-2 focus:ring-emerald-500 outline-none resize-none"
                    ></textarea>
                </div>
